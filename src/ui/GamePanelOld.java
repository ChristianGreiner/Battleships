...
public class GamePanelOld extends JPanel {
    ...
    public GamePanelOld(MapRenderer playerMapRenderer, MapRenderer enemyMapRenderer) {
    ...
    public GamePanelOld create(Dimension mapsRendererSize) {
        GamePanelOld panel = this;
        ...
        btnContainer.setPreferredSize(new Dimension(200, 32));
